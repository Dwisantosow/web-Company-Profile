  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-info">
            ...
            <div class="box-body">
              <form action="sistem/simpan_ubah_promo.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
              ...
              <button type="submid" class="pull-right btn btn-default">Ubah
